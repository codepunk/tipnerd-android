...
@AndroidEntryPoint
class MainActivity : AccountAuthenticatorComponentActivity() {
    ...
    override fun onNewIntent(intent: Intent) {
        ...
        Log.d(javaClass.simpleName, "onNewIntent: intent=$intent")
    }

    override fun onNewIntent(intent: Intent, caller: ComponentCaller) {
        super.onNewIntent(intent, caller)
        Log.d(javaClass.simpleName, "onNewIntent: intent=$intent, caller=$caller")
    }
